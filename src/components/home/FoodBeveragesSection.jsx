...
const FoodBeveragesSection = ({ products, onAddToCart, onAddToWishlist, onBuyNow, isInWishlist }) => {
  return (
              ...
              <div className="p-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-orange-600 hover:bg-orange-700 text-white text-sm font-medium py-2 px-3 rounded-lg transition-colors duration-200 flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-red-600 hover:bg-red-700 text-white text-sm font-medium py-2 px-3 rounded-lg transition-colors duration-200"
                  >
                    Buy Now
                  </button>
                </div>
