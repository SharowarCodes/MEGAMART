...
const SportsFitnessSection = ({ products, onAddToCart, onAddToWishlist, onBuyNow, isInWishlist }) => {
  return (
              ...
              <div className="p-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-green-600 hover:bg-green-700 text-white text-sm font-medium py-2 px-3 rounded-lg transition-colors duration-200 flex items-center justify-center"
                  >
...
export default SportsFitnessSection;
